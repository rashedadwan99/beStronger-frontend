...
export const UPDATE_PROFILE_FOLLOWERS_LIST = "UPDATE_PROFILE_FOLLOWERS_LIST";
...
export const updateProfileCardFollowersList = (user) => {
  return {
    type: UPDATE_PROFILE_FOLLOWERS_LIST,
    payload: user,
  };
};
